...
if(maxEV >= 1.30 && profitCount >= 2 && windEval !== "bad"){
  raceJudgement = "💰 攻めたい一戦。\n期待値・展開ともに噛み合い、本線勝負が可能。";
}
else if(maxEV >= 1.10 && profitCount >= 1 && windEval === "normal"){
  raceJudgement = "🤔 判断が分かれる一戦。\n決まり手次第で主導権が入れ替わる。";
}
else{
  raceJudgement = "🚫 手を出しづらいレース。\n外的条件の影響が大きく、再現性に欠ける。";
}
