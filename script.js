...
function selectRace() {
  ...
  calcAll(0); // 初期は stadiumIndex=0、選択時に差し替え
}
...
// メイン計算（過去傾向＋AI補正）
// ===============================
function calcAll(stadiumIndex) {

  let base = [], predict = [], ai = [];
  let trend = pastTrend[stadiumIndex];
...
function updateExpectationBars(base, predict, ai) {
  ...
  const colors = ["#fff","#000","#ff0000","#0000ff","#ffcc00","#33cc66"];
