...
function updateAnalysis(ai){
  ...
  const avgAI = ai.reduce((a,b)=>a+b,0) / ai.length;

  document.getElementById("aiPower").textContent = avgAI.toFixed(1) + "%";
  document.getElementById("hitRate").textContent = window.hitExpectation.toFixed(1) + "%";
